...
public class PhysicsSystem {
    ...
    public double getBoatWindAngle(Point firstPoint, Point secondPoint) {

        double angle = (Math.atan2((secondPoint.x - firstPoint.x), (secondPoint.y - firstPoint.y)) * 180 / Math.PI);
    ...
    public double timeBetweenPoints(Point from, Point to, Wind randomWind) {
        ...
        boatWindAngle = this.getBoatWindAngle(from,to);
